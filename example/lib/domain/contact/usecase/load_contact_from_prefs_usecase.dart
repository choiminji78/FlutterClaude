...
class LoadContactFromPrefsUseCase {
  const LoadContactFromPrefsUseCase(this._repository);

  final ContactRepository _repository;

  Future<AppResult<ContactEntity?>> call() => _repository.readContactFromPrefs();
}
