...
class LoadContactFromSecureUseCase {
  const LoadContactFromSecureUseCase(this._repository);

  final ContactRepository _repository;

  Future<AppResult<ContactEntity?>> call() => _repository.readContactFromSecure();
}
